...
const inputVariants = cva(
  'text-ui-body block w-full rounded-md border px-3 py-2 placeholder:text-gray-400 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors',
  {
    variants: {
      intent: {
